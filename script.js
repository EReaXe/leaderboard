...
let leaderboardData = [
  { name: "Ali K.", score: 14 },
  { name: "Beof Karaca", score: 24 },  
  { name: "Erkan Erkanson", score: 12 },
  { name: "Etli Pilav", score: 25 },
  { name: "Faruk", score: 13 },
  { name: "G. Ahmet M. P.", score: 21 },
  { name: "LunarLords", score: 22 },
  { name: "Melih Dolarım", score: 17 },
  { name: "Minar Sinan", score: 23 },
  { name: "Mustafa Rock", score: 20 },
];
